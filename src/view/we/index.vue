<template>
  <div id="we">
    <div class="s_banner">
      <div class="item">
        <img src="../../assets/5c2483df6e11431f8cde377b182a46cb.jpg" />
      </div>
...
.us_con_flist ul {
  ...
  max-width: 1280px;
  height: 100%;
  background: url("../../assets/us_li_b.png") no-repeat right center;
}
.us_con_flist ul li {
  float: left;
  width: 25%;
  height: 100%;
  background: url("../../assets/us_li_b.png") no-repeat left center;
  text-align: center;
}
a {
  transition: all 2s;
